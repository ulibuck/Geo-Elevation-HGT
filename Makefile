# This Makefile is for the Geo::Elevation::HGT extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Geo/Elevation/HGT.pm]
#     AUTHOR => [q[Ulrich Buck <ulibuck@web.de>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[artistic_2]
#     MIN_PERL_VERSION => q[5.010]
#     NAME => q[Geo::Elevation::HGT]
#     PREREQ_PM => { Carp=>q[0], File::Find=>q[0], HTTP::Tiny=>q[0], IO::Uncompress::AnyUncompress=>q[0], List::Util=>q[0], POSIX=>q[0], Test::More=>q[0] }
#     TEST_REQUIRES => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Geo/Elevation/HGT.pm]
#     clean => { FILES=>q[Geo-Elevation-HGT-*] }
...
MAKE = make
FULLEXT = Geo/Elevation/HGT
BASEEXT = HGT
PARENT_NAME = Geo::Elevation
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Geo/Elevation/HGT.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Geo/Elevation
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Geo/Elevation
...
TO_INST_PM = lib/Geo/Elevation/HGT.pm

PM_TO_BLIB = lib/Geo/Elevation/HGT.pm \
...
DISTNAME = Geo-Elevation-HGT
DISTVNAME = Geo-Elevation-HGT-0.01
...
manifypods : pure_all  \
	lib/Geo/Elevation/HGT.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/Geo/Elevation/HGT.pm $(INST_MAN3DIR)/Geo::Elevation::HGT.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Elevation service with terrain data provided by L<Mapzen and Amazon AWS S3|https://registry.opendata.aws/terrain-tiles/>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Ulrich Buck <ulibuck@web.de>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Geo-Elevation-HGT' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  IO::Uncompress::AnyUncompress: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Elevation service with terrain data provided by L<Mapzen and Amazon AWS S3|https://registry.opendata.aws/terrain-tiles/>",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Ulrich Buck <ulibuck@web.de>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Geo-Elevation-HGT",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "IO::Uncompress::AnyUncompress" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Elevation service with terrain data provided by L&lt;Mapzen and Amazon AWS S3|https://registry.opendata.aws/terrain-tiles/&gt;</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Ulrich Buck &lt;ulibuck@web.de&gt;</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="IO::Uncompress::AnyUncompress" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Geo/Elevation/HGT.pm blib/lib/Geo/Elevation/HGT.pm 
